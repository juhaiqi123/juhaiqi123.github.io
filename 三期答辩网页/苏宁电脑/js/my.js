...
//登录选项卡
var lis=document.querySelectorAll(".my .main .top ul li span");
var divs=document.querySelectorAll(".my .main .container #denglu");
...
for(var i=0;i<lis.length;i++){
    ...
    lis[i].onclick=function(){
        ...
        lis[this.ii].className="active";
        divs[this.ii].style.display="block";
    } 
}
var inputs=document.querySelectorAll(".my .main .container .input1");
var is=document.querySelectorAll(".my .main .container .i2");
console.log(inputs);
console.log(is);
for(var q=0;q<inputs.length;q++){
    inputs[q].qq=q;
    is[q].qq=q;
    inputs[q].onkeydown=function(){
        if(this.value==""){
            is[this.qq].style.display="none";
        }else{     
          is[this.qq].style.display="block";
        }
    }
     is[q].onclick=function(){
        inputs[this.qq].value="";
